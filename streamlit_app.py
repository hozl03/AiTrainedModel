...
important_cols.remove("YearBuilt")
important_cols.remove("YearRemodAdd")
important_cols.remove("TotalBsmtSF")
important_cols.remove("1stFlrSF")
important_cols.remove("GrLivArea")
important_cols.remove("FullBath")
important_cols.remove("TotRmsAbvGrd")
important_cols.remove("GarageCars")
important_cols.remove("MSZoning")
important_cols.remove("Utilities")
important_cols.remove("BldgType")
important_cols.remove("KitchenQual")
important_cols.remove("SaleCondition")
important_cols.remove("LandSlope")
